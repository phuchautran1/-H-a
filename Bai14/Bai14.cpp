...
void display()
{
	...
	V6.x = V0.x;
	V6.y = V0.y - R/2.5;
	V7.x = V0.x + (R*sin(pi / 5)) /2.5;
	V7.y = V0.y + (R*cos(pi / 5)/2.5);
	V8.x = V0.x + (R*sin(2*pi / 5)/2.5);
	V8.y = V0.y - (R*cos(2*pi / 5)/2.5);
	V9.x = V0.x - (R*sin(2*pi / 5)/2.5);
	V9.y = V0.y - (R*cos(2*pi / 5)/2.5);
	V10.x = V0.x - (R*sin(pi / 5)/2.5);
	V10.y = V0.y + (R*cos( pi / 5)/2.5);
